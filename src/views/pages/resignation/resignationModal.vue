                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" v-model="search.itemData.resignationDate">
                      </div>
                    </div>
  ...
  import axios from 'axios';
    export default {
      ...
      return {
        ...
        addresignationtype: ['general', 'abnormal'],
        editresignationstatus: ['active', 'ended'],
        
  
        tablePlaceHolder: "Resignation",
        isLoading: false,
      }
      },
      mounted() {
      ...
      methods: {
        async addNew() {
          ...
          data = {
            ...
            "resignationDate": this.search.itemData.resignationDate,
          ...
          // console.log(data); return;
                        try {
                          await axios.post('resign/add', data)
                              .then((result) => {
